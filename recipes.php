	...
	<div class="extra">
        ...
        <header>
        	<div class="top-row">
            	<div class="main">
                	<div class="wrapper">
                        <h1><a href="index.php">Restaurant Xingfú</a></h1>
                        <ul class="pagination">
                	...
                	<div class="main">
                        <nav>
                            <ul class="menu">
                                ...
                                <li><a href="about.php">La Carta</a></li>
                                <li><a class="active" href="recipes.php">Mi Carro</a></li>
                                <li><a href="calendar.php">Gatos</a></li>
                                <li class="last"><a href="contacts.php">Quiero hierba :c</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
                                ...
                                <div class="bg">
                                    <div class="padding">
                                        ...
                                        <div class="wrapper indent-bot">
                                        	<div class="column-1">
                                            	<div class="wrapper">
                                                	<figure class="img-indent"><a href="#"><img src="images/page4-img2.jpg" alt="" /></a></figure>
                                                    <div class="extra-wrap">
                                            ...
                                            <div class="column-2">
                                            	<div class="wrapper">
                                                	<figure class="img-indent"><a href="#"><img src="images/page4-img3.jpg" alt="" /></a></figure>
                                                    <div class="extra-wrap">
                                                    	<div class="margin-top">
                                        ...
                                        <div class="wrapper">
                                        	<div class="column-1">
                                            	<div class="wrapper">
                                                	<figure class="img-indent"><a href="#"><img src="images/page4-img4.jpg" alt="" /></a></figure>
                                                    <div class="extra-wrap">
                                                    	<div class="margin-top">
                                            ...
                                            <div class="column-2">
                                            	<div class="wrapper">
                                                	<figure class="img-indent"><a href="#"><img src="images/page4-img5.jpg" alt="" /></a></figure>
                                                    <div class="extra-wrap">
                                                    	<div class="margin-top">
